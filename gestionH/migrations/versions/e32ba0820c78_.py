...
Revision ID: e32ba0820c78
Revises: 
Create Date: 2018-06-19 21:45:19.000618
...
def upgrade():
    ...
    sa.Column('date_deb', sa.Date(), nullable=True),
    sa.Column('date_fin', sa.Date(), nullable=True),
    sa.ForeignKeyConstraint(['hotel_name'], ['hotel.name'], ),
    sa.ForeignKeyConstraint(['pro_name'], ['pro.name'], ),
    sa.PrimaryKeyConstraint('id')
    )
